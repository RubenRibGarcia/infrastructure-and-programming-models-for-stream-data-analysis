...
public class ObservableSimplifiedWazeJamsSerializer extends StdSerializer<ObservableSimplifiedWazeJamsModel> {

    public ObservableSimplifiedWazeJamsSerializer() {
        this(null);
    }

    public ObservableSimplifiedWazeJamsSerializer(Class<ObservableSimplifiedWazeJamsModel> vc) {
        super(vc);
    }

    @Override
    public void serialize(ObservableSimplifiedWazeJamsModel model
