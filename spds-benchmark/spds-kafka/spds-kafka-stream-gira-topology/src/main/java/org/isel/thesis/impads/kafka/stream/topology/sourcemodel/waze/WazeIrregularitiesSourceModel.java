package org.isel.thesis.impads.kafka.stream.topology.sourcemodel.waze;
...
public class WazeIrregularitiesSourceModel implements WazeIrregularitiesDataAdapter {
    ...
    @JsonProperty("type")
    public void setIrregularityIntensityType(IrregularityIntensityType irregularityIntensityType) {
