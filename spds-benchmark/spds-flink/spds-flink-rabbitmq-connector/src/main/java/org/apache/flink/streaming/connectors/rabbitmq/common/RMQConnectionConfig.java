...
public class RMQConnectionConfig implements Serializable {
	...
	private static final Logger LOG = LoggerFactory.getLogger(org.apache.flink.streaming.connectors.rabbitmq.common.RMQConnectionConfig.class);
	...
	*/
	...
	/**
	 * The Builder Class for {@link org.apache.flink.streaming.connectors.rabbitmq.common.RMQConnectionConfig}.
	 */
