...
public class IpmaTotalPrecipitationSourceModel implements IpmaTotalPrecipitationDataAdapter {
    ...
    public static final IRabbitMQQueue QUEUE = IRabbitMQQueue.RabbitMQQueueNaming.withName("ipma_total_precipitation");
    ...
    public static final class IpmaTotalPrecipitationTupleMapper implements TupleValueMapper<IpmaTotalPrecipitationSourceModel> {

        public static IpmaTotalPrecipitationTupleMapper map() {
            return new IpmaTotalPrecipitationTupleMapper();
        }

        @Override
        public IpmaTotalPrecipitationSourceModel apply(Tuple tuple) {
            return (IpmaTotalPrecipitationSourceModel) tuple.getValueByField("json");
        }
    }
}
