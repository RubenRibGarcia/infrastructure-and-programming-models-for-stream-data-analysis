package org.isel.thesis.impads.storm.sourcemodel.waze;
...
public class WazeIrregularitiesSourceModel implements WazeIrregularitiesDataAdapter, IJsonTuple, Serializable {
    ...
    public static final IRabbitMQQueue QUEUE = IRabbitMQQueue.RabbitMQQueueNaming.withName("waze_irregularities");
